        ...
        <div className="w-1/2 bg-white px-15 flex flex-col justify-between">
          <div className="flex-1 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit(loginController)} >
              ...
              <button
                type='submit'
                className="w-full bg-black text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition text-[10px] mb-6"
              >
                Submit
              </button>
            ...
            <p className="text-center text-[10px] text-gray-600">
              Don't have account?{' '}
              <button onClick={() => navigate('/register')} className="font-medium cursor-pointer text-gray-900 hover:underline">
                Register here
              </button>
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-gray-100 font-medium text-[10px] mb-1">{item.title}</h3>
